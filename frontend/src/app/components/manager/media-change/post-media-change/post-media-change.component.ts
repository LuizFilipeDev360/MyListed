...
@Component({
  selector: 'app-post-media-change',
  standalone: true,
  imports: [FormsModule],
  templateUrl: './post-media-change.component.html',
  styleUrl: './post-media-change.component.css'
})
export class PostMediaChangeComponent {
